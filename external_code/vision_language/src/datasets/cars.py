...
#         base_url = "https://huggingface.co/datasets/Donghyun99/Stanford-Cars/"

#         download_and_extract_archive(
#             url=base_url + "car_devkit.tgz",
...
#         if self._split == "train":
#             download_and_extract_archive(
#                 url=base_url + "cars_train.tgz",
#                 download_root=str(self._base_folder),
#                 md5=None,
#             )
#         else:
#             download_and_extract_archive(
#                 url=base_url + "cars_test.tgz",
#                 download_root=str(self._base_folder),
#                 md5=None,
#             )
#             download_url(
#                 url=base_url + "cars_test_annos_withlabels.mat",
...
class PytorchStanfordCars(Dataset):
    def __init__(self, root, split="train", transform=None, target_transform=None, download=False):
        self.dataset = load_dataset("Donghyun99/Stanford-Cars", split=split)
